...
{
    /// <summary>
    /// InlineResponse2004AssignedTo
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004AssignedTo :  IEquatable<InlineResponse2004AssignedTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004AssignedTo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2004AssignedTo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004AssignedTo" /> class.
        /// </summary>
        ...
        public InlineResponse2004AssignedTo(string Description = default(string), string Email = default(string), string FirstName = default(string), string Href = default(string), string Identifier = default(string), bool? IsEnabled = false, string LastName = default(string), string MiddleName = default(string), string Name = default(string), string Prefix = default(string), InlineResponse200Plans Roles = default(InlineResponse200Plans), InlineResponse200Plans Subscriptions = default(InlineResponse200Plans), string Suffix = default(string))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for InlineResponse2004AssignedTo and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2004AssignedTo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2004AssignedTo);
        }

        /// <summary>
        /// Returns true if InlineResponse2004AssignedTo instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2004AssignedTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004AssignedTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

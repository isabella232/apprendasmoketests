...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(bool? UpgradeInProgress = false)
        {
            // to ensure "UpgradeInProgress" is required (not null)
            if (UpgradeInProgress == null)
            {
                throw new InvalidDataException("UpgradeInProgress is a required property for InlineResponse2005 and cannot be null");
            }
            else
            {

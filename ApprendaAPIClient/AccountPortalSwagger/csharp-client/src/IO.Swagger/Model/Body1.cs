...
namespace IO.Swagger.Model
{
    ...
    public partial class Body1 :  IEquatable<Body1>, IValidatableObject
    {
        ...
        public Body1(string Id = default(string), string Description = default(string), string Href = default(string), string Name = default(string), InlineResponse200Plans Roles = default(InlineResponse200Plans), InlineResponse200Plans Securables = default(InlineResponse200Plans), InlineResponse200Plans Users = default(InlineResponse200Plans))
        {

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse200Items :  IEquatable<InlineResponse200Items>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Stage
        /// </summary>
        ...
        public InlineResponse200Items(string ProviderName = default(string), string ApplicationAlias = default(string), string ApplicationDescription = default(string), string ApplicationName = default(string), string VersionAlias = default(string), StageEnum? Stage = default(StageEnum?), InlineResponse200Plans Plans = default(InlineResponse200Plans), InlineResponse200Plans Securables = default(InlineResponse200Plans), string Href = default(string))
        {

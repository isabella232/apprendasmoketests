...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(string Href = default(string), List<InlineResponse2004AssignedTo> Items = default(List<InlineResponse2004AssignedTo>))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for InlineResponse2006 and cannot be null");
            }
            else
            {
                this.Items = Items;

...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(string Href = default(string), List<InlineResponse2002Items> Items = default(List<InlineResponse2002Items>))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for InlineResponse2002 and cannot be null");
            }
            else
            {
                this.Items = Items;

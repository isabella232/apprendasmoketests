...
namespace IO.Swagger.Model
{
    ...
    public partial class Body2 :  IEquatable<Body2>, IValidatableObject
    {
        ...
        public Body2(string Id = default(string), string Description = default(string), string Href = default(string), string Name = default(string), InlineResponse200Plans Roles = default(InlineResponse200Plans), InlineResponse200Plans Securables = default(InlineResponse200Plans), InlineResponse200Plans Users = default(InlineResponse200Plans))
        {
            // to ensure "Description" is required (not null)
            if (Description == null)
            {
                throw new InvalidDataException("Description is a required property for Body2 and cannot be null");
            }
            else
            {

...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(string Href = default(string), List<Apiv1applicationVersionsapplicationVersionKeyplansItems> Items = default(List<Apiv1applicationVersionsapplicationVersionKeyplansItems>))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
                this.Items = Items;

...
{
    /// <summary>
    /// Apiv1applicationVersionsapplicationVersionKeyplansItems
    /// </summary>
    [DataContract]
    public partial class Apiv1applicationVersionsapplicationVersionKeyplansItems :  IEquatable<Apiv1applicationVersionsapplicationVersionKeyplansItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Apiv1applicationVersionsapplicationVersionKeyplansItems" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Apiv1applicationVersionsapplicationVersionKeyplansItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Apiv1applicationVersionsapplicationVersionKeyplansItems" /> class.
        /// </summary>
        ...
        public Apiv1applicationVersionsapplicationVersionKeyplansItems(string Id = default(string), string Href = default(string), string Name = default(string))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for Apiv1applicationVersionsapplicationVersionKeyplansItems and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Apiv1applicationVersionsapplicationVersionKeyplansItems {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Apiv1applicationVersionsapplicationVersionKeyplansItems);
        }

        /// <summary>
        /// Returns true if Apiv1applicationVersionsapplicationVersionKeyplansItems instances are equal
        /// </summary>
        /// <param name="other">Instance of Apiv1applicationVersionsapplicationVersionKeyplansItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Apiv1applicationVersionsapplicationVersionKeyplansItems other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

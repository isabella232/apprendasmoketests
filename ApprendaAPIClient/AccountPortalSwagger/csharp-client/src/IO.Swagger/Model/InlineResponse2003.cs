...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(string Href = default(string), List<InlineResponse2003Items> Items = default(List<InlineResponse2003Items>))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for InlineResponse2003 and cannot be null");
            }
            else
            {
                this.Items = Items;

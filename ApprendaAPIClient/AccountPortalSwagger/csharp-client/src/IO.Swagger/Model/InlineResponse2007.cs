...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(int? CurrentPage = default(int?), string Href = default(string), List<InlineResponse2004AssignedTo> Items = default(List<InlineResponse2004AssignedTo>), InlineResponse200Plans NextPage = default(InlineResponse200Plans), int? PageSize = default(int?), InlineResponse200Plans PreviousPage = default(InlineResponse200Plans), long? TotalItems = default(long?), int? TotalPages = default(int?))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for InlineResponse2007 and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<InlineResponse2004AssignedTo> Items { get; set; }
        /// <summary>

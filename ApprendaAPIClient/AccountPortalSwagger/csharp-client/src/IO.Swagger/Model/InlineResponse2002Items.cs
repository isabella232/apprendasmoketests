...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2002Items :  IEquatable<InlineResponse2002Items>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002Items" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2002Items() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002Items" /> class.
        /// </summary>
        ...
        public InlineResponse2002Items(InlineResponse200Plans ApplicationVersion = default(InlineResponse200Plans), string Href = default(string), bool? IsRuntime = false, string Id = default(string), string Name = default(string), List<InlineResponse200Plans> Roles = default(List<InlineResponse200Plans>))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for InlineResponse2002Items and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2002Items);
        }

...
<a name="contextget"></a>
# **ContextGet**
> InlineResponse20010 ContextGet (string returnAddress = null)
...
namespace Example
{
    public class ContextGetExample
    {
        public void main()
        {
            ...
            try
            {
                InlineResponse20010 result = apiInstance.ContextGet(returnAddress);
...
> InlineResponse20010 ContextGetBySubAlias (string alias, string subAlias, string returnAddress = null)
...
namespace Example
{
    public class ContextGetBySubAliasExample
    {
        public void main()
        {
            ...
            try
            {
                InlineResponse20010 result = apiInstance.ContextGetBySubAlias(alias, subAlias, returnAddress);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedResourceBaseSubscribedTenant :  IEquatable<PagedResourceBaseSubscribedTenant>, IValidatableObject
    {
        /// <summary>
        ...
        public PagedResourceBaseSubscribedTenant(int? CurrentPage = default(int?), int? PageSize = default(int?), int? TotalPages = default(int?), long? TotalItems = default(long?), List<InlineResponse20026Items> Items = default(List<InlineResponse20026Items>), InlineResponse200Icon NextPage = default(InlineResponse200Icon), InlineResponse200Icon PreviousPage = default(InlineResponse200Icon), string Href = default(string))
        {
        ...
        public List<InlineResponse20026Items> Items { get; set; }
        /// <summary>

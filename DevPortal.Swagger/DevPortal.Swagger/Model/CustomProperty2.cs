...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomProperty2 :  IEquatable<CustomProperty2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomProperty2" /> class.
        /// </summary>
        ...
        public CustomProperty2(InlineResponse200Icon Version = default(InlineResponse200Icon), InlineResponse200Icon ReferencedObject = default(InlineResponse200Icon), InlineResponse20011 PropertyModel = default(InlineResponse20011), List<string> Values = default(List<string>), string Href = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomProperty2 {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CustomProperty2);
        }

        /// <summary>
        /// Returns true if CustomProperty2 instances are equal
        /// </summary>
        /// <param name="other">Instance of CustomProperty2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomProperty2 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

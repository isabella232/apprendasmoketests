...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20019 :  IEquatable<InlineResponse20019>, IValidatableObject
    {
        ...
        public InlineResponse20019(Guid? Locator = default(Guid?), Apiv1monitoringsubscriptionsappAliasversionAliasComponent Component = default(Apiv1monitoringsubscriptionsappAliasversionAliasComponent), int? UpdateInterval = default(int?), List<string> Properties = default(List<string>), string Href = default(string))
        {

...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(string FileName = default(string), string Type = default(string), string SerialNumber = default(string), string Issuer = default(string), string Href = default(string))
        {

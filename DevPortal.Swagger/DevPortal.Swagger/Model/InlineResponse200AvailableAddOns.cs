...
{
    /// <summary>
    /// InlineResponse200AvailableAddOns
    /// </summary>
    [DataContract]
    public partial class InlineResponse200AvailableAddOns :  IEquatable<InlineResponse200AvailableAddOns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200AvailableAddOns" /> class.
        /// </summary>
        ...
        public InlineResponse200AvailableAddOns(int? ManifestVersion = default(int?), string Name = default(string), string Alias = default(string), string Description = default(string), string Version = default(string), string Author = default(string), string Vendor = default(string), string DeveloperHelp = default(string), string DeploymentNotes = default(string), int? MaxInstancesPerDevTeam = default(int?), bool? AllowUserDefinedParameters = default(bool?), List<InlineResponse200Parameters> Parameters = default(List<InlineResponse200Parameters>), InlineResponse200Instances Instances = default(InlineResponse200Instances), InlineResponse200Icon Icon = default(InlineResponse200Icon), string Href = default(string))
        {
        ...
        public List<InlineResponse200Parameters> Parameters { get; set; }
        /// <summary>
        ...
        public InlineResponse200Icon Icon { get; set; }
        /// <summary>
        /// Gets or Sets Href
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse200AvailableAddOns {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse200AvailableAddOns);
        }

        /// <summary>
        /// Returns true if InlineResponse200AvailableAddOns instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse200AvailableAddOns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200AvailableAddOns other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

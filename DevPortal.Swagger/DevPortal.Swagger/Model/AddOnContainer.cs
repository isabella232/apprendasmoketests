...
namespace IO.Swagger.Model
{
    ...
    public partial class AddOnContainer :  IEquatable<AddOnContainer>, IValidatableObject
    {
        ...
        public AddOnContainer(List<InlineResponse200AvailableAddOns> AvailableAddOns = default(List<InlineResponse200AvailableAddOns>), List<InlineResponse200DeployedAddOns> DeployedAddOns = default(List<InlineResponse200DeployedAddOns>), string Href = default(string))
        {

...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(string Name = default(string), string Path = default(string), bool? IsDirectory = default(bool?), InlineResponse200Icon Component = default(InlineResponse200Icon), string Href = default(string))
        {
            this.Name = Name;
            this.Path = Path;

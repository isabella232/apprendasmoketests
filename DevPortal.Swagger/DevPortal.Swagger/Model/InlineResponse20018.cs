...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20018 :  IEquatable<InlineResponse20018>, IValidatableObject
    {
        ...
        public InlineResponse20018(int? TotalCount = default(int?), int? DebugCount = default(int?), int? InfoCount = default(int?), int? WarningCount = default(int?), int? ErrorCount = default(int?), int? FatalCount = default(int?), string Href = default(string))
        {

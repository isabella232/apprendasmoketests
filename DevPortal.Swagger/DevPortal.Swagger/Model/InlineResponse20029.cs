...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20029 :  IEquatable<InlineResponse20029>, IValidatableObject
    {
        ...
        public InlineResponse20029(bool? Success = default(bool?), DateTime? BeginDate = default(DateTime?), DateTime? EndDate = default(DateTime?), StatusEnum? Status = default(StatusEnum?), List<Apiv1versionsappAliasversionAliasreportCardsSections> Sections = default(List<Apiv1versionsappAliasversionAliasreportCardsSections>))
        {
        ...
        public List<Apiv1versionsappAliasversionAliasreportCardsSections> Sections { get; set; }
        /// <summary>

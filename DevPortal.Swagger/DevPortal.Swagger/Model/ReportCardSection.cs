...
namespace IO.Swagger.Model
{
    ...
    public partial class ReportCardSection :  IEquatable<ReportCardSection>, IValidatableObject
    {
        ...
        public ReportCardSection(string Title = default(string), bool? Success = default(bool?), List<Apiv1versionsappAliasversionAliasreportCardsMessages> Messages = default(List<Apiv1versionsappAliasversionAliasreportCardsMessages>), DateTime? BeginDate = default(DateTime?), DateTime? EndDate = default(DateTime?), bool? Finished = default(bool?), bool? Canceled = default(bool?), OperationTypeEnum? OperationType = default(OperationTypeEnum?))
        {
            this.Title = Title;

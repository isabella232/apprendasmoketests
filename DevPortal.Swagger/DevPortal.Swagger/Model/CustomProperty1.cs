...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomProperty1 :  IEquatable<CustomProperty1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomProperty1" /> class.
        /// </summary>
        ...
        public CustomProperty1(InlineResponse200Icon Version = default(InlineResponse200Icon), InlineResponse200Icon ReferencedObject = default(InlineResponse200Icon), InlineResponse20011 PropertyModel = default(InlineResponse20011), List<string> Values = default(List<string>), string Href = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomProperty1 {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CustomProperty1);
        }

        /// <summary>
        /// Returns true if CustomProperty1 instances are equal
        /// </summary>
        /// <param name="other">Instance of CustomProperty1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomProperty1 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

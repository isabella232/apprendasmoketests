...
namespace IO.Swagger.Model
{
    ...
    public partial class ReportCard :  IEquatable<ReportCard>, IValidatableObject
    {
        ...
        public ReportCard(bool? Success = default(bool?), DateTime? BeginDate = default(DateTime?), DateTime? EndDate = default(DateTime?), StatusEnum? Status = default(StatusEnum?), List<Apiv1versionsappAliasversionAliasreportCardsSections> Sections = default(List<Apiv1versionsappAliasversionAliasreportCardsSections>))
        {

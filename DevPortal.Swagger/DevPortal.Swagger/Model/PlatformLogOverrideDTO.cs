...
namespace IO.Swagger.Model
{
    ...
    public partial class PlatformLogOverrideDTO :  IEquatable<PlatformLogOverrideDTO>, IValidatableObject
    {
        ...
        public PlatformLogOverrideDTO(string AppAlias = default(string), string AppVersion = default(string), string DevTeamAlias = default(string), Apiv1LogOverridesUser User = default(Apiv1LogOverridesUser), Apiv1LogOverridesTenant Tenant = default(Apiv1LogOverridesTenant), Apiv1LogOverridesLogOverride LogOverride = default(Apiv1LogOverridesLogOverride))
        {
        ...
        public Apiv1LogOverridesTenant Tenant { get; set; }
        /// <summary>
        /// Gets or Sets LogOverride
        /// </summary>
        [DataMember(Name="logOverride", EmitDefaultValue=false)]
        public Apiv1LogOverridesLogOverride LogOverride { get; set; }
        /// <summary>

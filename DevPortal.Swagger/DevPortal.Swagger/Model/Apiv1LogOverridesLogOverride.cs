...
{
    /// <summary>
    /// Apiv1LogOverridesLogOverride
    /// </summary>
    [DataContract]
    public partial class Apiv1LogOverridesLogOverride :  IEquatable<Apiv1LogOverridesLogOverride>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Apiv1LogOverridesLogOverride" /> class.
        /// </summary>
        ...
        public Apiv1LogOverridesLogOverride(Guid? Id = default(Guid?), int? LogLevel = default(int?), Guid? VersionId = default(Guid?), bool? AggregateRepeatedLogs = default(bool?), int? RepeatedLogNotificationFrequency = default(int?), List<Apiv1LogOverridesLogOverrideOverrideEmailRecipients> OverrideEmailRecipients = default(List<Apiv1LogOverridesLogOverrideOverrideEmailRecipients>))
        {
            this.Id = Id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Apiv1LogOverridesLogOverride {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Apiv1LogOverridesLogOverride);
        }

        /// <summary>
        /// Returns true if Apiv1LogOverridesLogOverride instances are equal
        /// </summary>
        /// <param name="other">Instance of Apiv1LogOverridesLogOverride to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Apiv1LogOverridesLogOverride other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

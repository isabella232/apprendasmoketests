...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ovr1 :  IEquatable<Ovr1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ovr1" /> class.
        /// </summary>
        ...
        public Ovr1(Guid? Id = default(Guid?), int? LogLevel = default(int?), string AppAlias = default(string), string AppVersion = default(string), List<string> EmailRecipients = default(List<string>), string OverrideType = default(string), string Tag = default(string), Apiv1LogOverridesSubscriber Subscriber = default(Apiv1LogOverridesSubscriber), Apiv1LogOverridesUser User = default(Apiv1LogOverridesUser), string Message = default(string), Apiv1LogOverridesNotification Notification = default(Apiv1LogOverridesNotification), string Href = default(string))
        {
            this.Id = Id;
        ...
        public Apiv1LogOverridesSubscriber Subscriber { get; set; }
        /// <summary>
        /// Gets or Sets User
        /// </summary>
        [DataMember(Name="user", EmitDefaultValue=false)]
        public Apiv1LogOverridesUser User { get; set; }
        /// <summary>
        ...
        public Apiv1LogOverridesNotification Notification { get; set; }
        /// <summary>
        /// Gets or Sets Href
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ovr1);
        }

        /// <summary>
        /// Returns true if Ovr1 instances are equal
        /// </summary>
        /// <param name="other">Instance of Ovr1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ovr1 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

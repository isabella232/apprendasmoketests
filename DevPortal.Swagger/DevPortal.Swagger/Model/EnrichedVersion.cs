...
namespace IO.Swagger.Model
{
    ...
    public partial class EnrichedVersion :  IEquatable<EnrichedVersion>, IValidatableObject
    {
        ...
        public EnrichedVersion(string Url = default(string), double? LastHourUptime = default(double?), double? LastDayUptime = default(double?), double? LastMonthUptime = default(double?), InlineResponse200Icon PreviousVersion = default(InlineResponse200Icon), InlineResponse200Icon Components = default(InlineResponse200Icon), InlineResponse200Icon Workloads = default(InlineResponse200Icon), InlineResponse200Icon CustomProperties = default(InlineResponse200Icon), InlineResponse200Icon ArchiveDownload = default(InlineResponse200Icon), InlineResponse200Icon FilesDownload = default(InlineResponse200Icon), InlineResponse200Icon ManifestDownload = default(InlineResponse200Icon), InlineResponse200Icon Tenants = default(InlineResponse200Icon), string Name = default(string), string Alias = default(string), string Description = default(string), string Stage = default(string), string State = default(string), InlineResponse200Icon Application = default(InlineResponse200Icon), bool? EnableStickySessions = default(bool?), bool? EnableSessionReplication = default(bool?), bool? EnableSslEnforcement = default(bool?), LoadBalancerUrlConfigurationEnum? LoadBalancerUrlConfiguration = default(LoadBalancerUrlConfigurationEnum?), bool? InMaintenance = default(bool?), string Href = default(string))
        {
            this.Url = Url;
        ...
        public InlineResponse200Icon PreviousVersion { get; set; }
        /// <summary>
        /// Gets or Sets Components
        /// </summary>
        [DataMember(Name="components", EmitDefaultValue=false)]
        public InlineResponse200Icon Components { get; set; }
        /// <summary>
        /// Gets or Sets Workloads
        /// </summary>
        [DataMember(Name="workloads", EmitDefaultValue=false)]
        public InlineResponse200Icon Workloads { get; set; }
        /// <summary>

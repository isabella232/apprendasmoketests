...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20028 :  IEquatable<InlineResponse20028>, IValidatableObject
    {
        ...
        public InlineResponse20028(int? SampleCount = default(int?), double? MinimumCpuUsage = default(double?), double? AverageCpuUsage = default(double?), double? MaximumCpuUsage = default(double?), double? StandardDeviationCpuUsage = default(double?), double? MinimumMemoryUsage = default(double?), double? AverageMemoryUsage = default(double?), double? MaximumMemoryUsage = default(double?), double? StandardDeviationMemoryUsage = default(double?), InlineResponse200Icon Workload = default(InlineResponse200Icon), bool? IsPolicyApplicable = default(bool?), string Href = default(string))
        {

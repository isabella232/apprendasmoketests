...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20024 :  IEquatable<InlineResponse20024>, IValidatableObject
    {
        ...
        public InlineResponse20024(string Notes = default(string), bool? DeploymentAllowed = default(bool?), string Description = default(string), long? UnitSize = default(long?), long? MaxUnits = default(long?), string Cost = default(string), bool? IsUnlimited = default(bool?), string Name = default(string), string Href = default(string))
        {
            this.Notes = Notes;

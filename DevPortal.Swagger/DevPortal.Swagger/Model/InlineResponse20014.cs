...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20014 :  IEquatable<InlineResponse20014>, IValidatableObject
    {
        ...
        public InlineResponse20014(int? Id = default(int?), string Name = default(string), ContainerTypeEnum? ContainerType = default(ContainerTypeEnum?), string Path = default(string), bool? IsEnabled = default(bool?), bool? IsDefault = default(bool?), bool? IsSystem = default(bool?))
        {
            this.Id = Id;
            this.Name = Name;
